    ...
    >
      <div className="max-w-4xl mx-auto">
        ...
        <div className="space-y-8">
          ...
          {/* Section */}
          <section className="liquid-glass rounded-2xl p-6 sm:p-8 space-y-4">
            <h2 className="text-xl sm:text-2xl text-primary font-[Hobo_BT]">5. AI-Powered Chat Widget</h2>
            <p className="text-muted-foreground leading-relaxed">
              Our website features an AI-powered chat assistant designed to help visitors learn about our services and professional background. By using the chat widget, you acknowledge and agree that:
            </p>
            <ul className="list-disc list-inside space-y-2 text-muted-foreground pl-4">
              <li>Responses are generated by artificial intelligence (AI) and may not always be 100% accurate</li>
              <li>Your messages are processed by third-party AI providers (Groq, OpenAI) to generate responses</li>
              <li>Chat conversations are stored for quality assurance and service improvement purposes</li>
              <li>The AI assistant is limited to providing information about this portfolio and related services</li>
              <li>AI responses do not constitute professional advice, and you should verify important information independently</li>
              <li>Do not share sensitive personal information, passwords, or confidential data in the chat</li>
            </ul>
            <p className="text-muted-foreground leading-relaxed mt-4">
              For detailed inquiries or professional consultations, please use the contact form or email directly.
            </p>
          </section>
          ...
          {/* Section */}
          <section className="liquid-glass rounded-2xl p-6 sm:p-8 space-y-4">
            <h2 className="text-xl sm:text-2xl text-primary font-[Hobo_BT]">7. Limitation of Liability</h2>
            <p className="text-muted-foreground leading-relaxed">
          ...
          {/* Section */}
          <section className="liquid-glass rounded-2xl p-6 sm:p-8 space-y-4">
            <h2 className="text-xl sm:text-2xl text-primary font-[Hobo_BT]">8. External Links</h2>
            <p className="text-muted-foreground leading-relaxed">
          ...
          {/* Section */}
          <section className="liquid-glass rounded-2xl p-6 sm:p-8 space-y-4">
            <h2 className="text-xl sm:text-2xl text-primary font-[Hobo_BT]">9. Governing Law</h2>
            <p className="text-muted-foreground leading-relaxed">
          ...
          {/* Section */}
          <section className="liquid-glass rounded-2xl p-6 sm:p-8 space-y-4">
            <h2 className="text-xl sm:text-2xl text-primary font-[Hobo_BT]">10. Changes to Terms</h2>
            <p className="text-muted-foreground leading-relaxed">
          ...
          {/* Section */}
          <section className="liquid-glass rounded-2xl p-6 sm:p-8 space-y-4">
            <h2 className="text-xl sm:text-2xl text-primary font-[Hobo_BT]">11. Contact Information</h2>
            <p className="text-muted-foreground leading-relaxed">
